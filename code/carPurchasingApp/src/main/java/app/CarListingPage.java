...
private JPanel createNavBarPanel() {
    ...
    titleBtn.addActionListener((ActionEvent e) -> {
    ...
    carsForSaleBtn.addActionListener((ActionEvent e) -> {
        // Direct to car listing page (current page)
    });
    ...
    advertiseCarBtn.addActionListener((ActionEvent e) -> {
    ...
    searchIconBtn.addActionListener((ActionEvent e) -> {
    ...
    private void populateCarListings(JPanel carListingPanel) {
        try {
             conn = Databaseconnection.openConnection(); // Connect to the database
            if (conn != null) {
